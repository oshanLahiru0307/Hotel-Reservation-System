<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
            ...
            <body>
                ...
                String ID=request.getParameter("id"); 
                  ...
                  try{ 
                    ...
                    Statement stmt=con.createStatement(); ResultSet rs=stmt.executeQuery("select * from customer where Cus_id ='"+ID+"' ");
    ...
    <div class=" container">
                    ...
                    <form action="UpdateCusRegister" method="post">
                        ...
                        <p>User Name</p>
                        <input type="text" placeholder="Enter your User Name" value="<%= rs.getString(5) %>"
                        ...
                        <input id="password" type="Password" placeholder="Enter your Password"
                            value="<%= rs.getString(6) %>" name="Password" required>
